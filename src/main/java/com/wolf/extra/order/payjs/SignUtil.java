...
public class SignUtil {
	...
	public static String getPayUrl(String orderId, int price,
			...
			String body,
			String host) {
		String notifyUrl = "http://www.51fabu1.live:8099/v2/order/payjs/complete";
		...
		return payUrl + "?mchid=" + mchid + "&notify_url=" + notifyUrl + "&callback_url=" + callbackUrl + "&out_trade_no=" + orderNumber + "&total_fee=" + price + "&sign=" + sign;
	}
